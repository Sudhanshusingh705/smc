...
// import "./VeterinaryScience.css";

const VeterinaryScience = () => {
  ...
  return (
    <div className="section">
      <h2 className="section-title">
        Top Veterinary Science Colleges in India 2023-2024
      </h2>
      <MDBContainer fluid>
        <MDBRow>
          <MDBCol md="9" className="mx-auto">
            <div className="pageDescription text-center">
              <h1>Veterinary Science Colleges</h1>
              ...
              {showContent ? (
                <>
                  ...
                  <h1>Veterinary Science Colleges </h1>
              <h2>
                Veterinary Science College: Eligibility, Admission, Syllabus, Placements
              </h2>
                  <p>
                    <div className="mb-2">
                      <span>
                      Veterinary Science courses are training-based courses that aim at
                      preparing students for a particular career, skill, or
                      trade. Unlike traditional courses like BE/BTech/MBBS;
                      Veterinary Science courses focus on practical skills, and on-site
                      training and thus offer better & quicker job
                      opportunities. There are thousands of Veterinary Science courses
                      in different fields. Among the Veterinary Science courses listed;
                      Telecommunication, Photography, Foreign Languages,
                      Information Technology (IT), Beautician, and Hotel
                      Management are on the top. BVoc (Bachelor of Veterinary Science
                      Studies) is a popular Veterinary Science degree course in India.
                      ...
                      Graphics & Multimedia) are the Top Veterinary Science Institutes.
                      The eligibility and admission criteria for Veterinary Science
                      courses is quite flexible. Students need to pass the class
                      10 and class 12 exams with minimum qualifying marks and
                      from a recognized board. Veterinary Science courses take less than
                      2 years and the average cost to pursue any Veterinary Science
...
export default VeterinaryScience;
